...
Bracket_Sim <- function(year, N, model_type)
{
  ...
  if (year == current_tourn_year)
  {
    ...
    bracket <- bracket[bracket$TeamName_Team1 != "Howard" & bracket$TeamName_Team2 != "Howard",]
    bracket <- bracket[bracket$TeamName_Team1 != "Virginia" & bracket$TeamName_Team2 != "Virginia",]
    bracket <- bracket[bracket$TeamName_Team1 != "Montana St" & bracket$TeamName_Team2 != "Montana St",]
    bracket <- bracket[bracket$TeamName_Team1 != "Boise St" & bracket$TeamName_Team2 != "Boise St",]
  }  
  ...
  for (j in seq(1,N))
  {
    ...
    kaggle_submission[[j]]$Tournament <- 'M'
    ...
    kaggle_submission[[j]]$RowId <- 0:62
